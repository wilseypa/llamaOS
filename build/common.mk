...
CFLAGS = $(XFLAGS) \
  ...
  -nostdinc
# -fno-common -std=gnu99 -fgnu89-inline -nostdinc
...
CPPFLAGS = $(XFLAGS) \
  ...
  -fuse-cxa-atexit 
# -fno-common -std=gnu++0x -nostdinc -nostdinc++
...
SRCDIR = ../src
GLIBCDIR = $(SRCDIR)/glibc-2.16.0
GCCDIR = $(SRCDIR)/gcc-4.7.1
XENDIR = $(SRCDIR)/xen-4.1.2
