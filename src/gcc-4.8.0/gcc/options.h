...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1037,            /* -m128bit-long-double */
  OPT_m32 = 1038,                            /* -m32 */
  OPT_m3dnow = 1039,                         /* -m3dnow */
  OPT_m3dnowa = 1040,                        /* -m3dnowa */
  OPT_m64 = 1041,                            /* -m64 */
  OPT_m80387 = 1042,                         /* -m80387 */
  OPT_m8bit_idiv = 1043,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1044,             /* -m96bit-long-double */
  OPT_mabi_ = 1045,                          /* -mabi= */
  OPT_mabm = 1046,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1047,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1048,                 /* -maddress-mode= */
  OPT_madx = 1049,                           /* -madx */
  OPT_maes = 1050,                           /* -maes */
  OPT_malign_double = 1051,                  /* -malign-double */
  OPT_malign_functions_ = 1052,              /* -malign-functions= */
  OPT_malign_jumps_ = 1053,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1054,                  /* -malign-loops= */
  OPT_malign_stringops = 1055,               /* -malign-stringops */
  OPT_mandroid = 1056,                       /* -mandroid */
  OPT_march_ = 1057,                         /* -march= */
  OPT_masm_ = 1058,                          /* -masm= */
  OPT_mavx = 1059,                           /* -mavx */
  OPT_mavx2 = 1060,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1061,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1062,  /* -mavx256-split-unaligned-store */
  OPT_mbionic = 1063,                        /* -mbionic */
  OPT_mbmi = 1064,                           /* -mbmi */
  OPT_mbmi2 = 1065,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1066,                  /* -mbranch-cost= */
  OPT_mcld = 1067,                           /* -mcld */
  OPT_mcmodel_ = 1068,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1069, */                    /* -mcpu= */
  OPT_mcrc32 = 1070,                         /* -mcrc32 */
  OPT_mcx16 = 1071,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1072,            /* -mdispatch-scheduler */
  OPT_mf16c = 1073,                          /* -mf16c */
  OPT_mfancy_math_387 = 1074,                /* -mfancy-math-387 */
  OPT_mfentry = 1075,                        /* -mfentry */
  OPT_mfma = 1076,                           /* -mfma */
  OPT_mfma4 = 1077,                          /* -mfma4 */
  OPT_mforce_drap = 1078,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1079,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1080,                       /* -mfpmath= */
  OPT_mfsgsbase = 1081,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1082, */              /* -mfused-madd */
  OPT_mfxsr = 1083,                          /* -mfxsr */
  OPT_mglibc = 1084,                         /* -mglibc */
  OPT_mhard_float = 1085,                    /* -mhard-float */
  OPT_mhle = 1086,                           /* -mhle */
  OPT_mieee_fp = 1087,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1088,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1089,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1090,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1091, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1092,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1093,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1094,                /* -mlong-double-80 */
  OPT_mlwp = 1095,                           /* -mlwp */
  OPT_mlzcnt = 1096,                         /* -mlzcnt */
  OPT_mmmx = 1097,                           /* -mmmx */
  OPT_mmovbe = 1098,                         /* -mmovbe */
  OPT_mms_bitfields = 1099,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1100,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1101,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1102,                  /* -mno-push-args */
  OPT_mno_red_zone = 1103,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1104,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1105,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1106,                          /* -mpc32 */
  OPT_mpc64 = 1107,                          /* -mpc64 */
  OPT_mpc80 = 1108,                          /* -mpc80 */
  OPT_mpclmul = 1109,                        /* -mpclmul */
  OPT_mpopcnt = 1110,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1111,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1112,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1113,                        /* -mprfchw */
  OPT_mpush_args = 1114,                     /* -mpush-args */
  OPT_mrdrnd = 1115,                         /* -mrdrnd */
  OPT_mrdseed = 1116,                        /* -mrdseed */
  OPT_mrecip = 1117,                         /* -mrecip */
  OPT_mrecip_ = 1118,                        /* -mrecip= */
  OPT_mred_zone = 1119,                      /* -mred-zone */
  OPT_mregparm_ = 1120,                      /* -mregparm= */
  OPT_mrtd = 1121,                           /* -mrtd */
  OPT_mrtm = 1122,                           /* -mrtm */
  OPT_msahf = 1123,                          /* -msahf */
  OPT_msoft_float = 1124,                    /* -msoft-float */
  OPT_msse = 1125,                           /* -msse */
  OPT_msse2 = 1126,                          /* -msse2 */
  OPT_msse2avx = 1127,                       /* -msse2avx */
  OPT_msse3 = 1128,                          /* -msse3 */
  OPT_msse4 = 1129,                          /* -msse4 */
  OPT_msse4_1 = 1130,                        /* -msse4.1 */
  OPT_msse4_2 = 1131,                        /* -msse4.2 */
  OPT_msse4a = 1132,                         /* -msse4a */
  /* OPT_msse5 = 1133, */                    /* -msse5 */
  OPT_msseregparm = 1134,                    /* -msseregparm */
  OPT_mssse3 = 1135,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1136,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1137,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1138,            /* -mstringop-strategy= */
  OPT_mtbm = 1139,                           /* -mtbm */
  OPT_mtls_dialect_ = 1140,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1141,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1142,                         /* -mtune= */
  OPT_muclibc = 1143,                        /* -muclibc */
  OPT_mveclibabi_ = 1144,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1145,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1146,                    /* -mvzeroupper */
  OPT_mx32 = 1147,                           /* -mx32 */
  OPT_mxop = 1148,                           /* -mxop */
  OPT_mxsave = 1149,                         /* -mxsave */
  OPT_mxsaveopt = 1150,                      /* -mxsaveopt */
  OPT_n = 1151,                              /* -n */
  OPT_no_canonical_prefixes = 1152,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1153,              /* -no-integrated-cpp */
  OPT_nocpp = 1154,                          /* -nocpp */
  OPT_nodefaultlibs = 1155,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1156,                   /* -nostartfiles */
  OPT_nostdinc = 1157,                       /* -nostdinc */
  OPT_nostdinc__ = 1158,                     /* -nostdinc++ */
  OPT_nostdlib = 1159,                       /* -nostdlib */
  OPT_o = 1160,                              /* -o */
  OPT_p = 1161,                              /* -p */
  OPT_pass_exit_codes = 1162,                /* -pass-exit-codes */
  /* OPT_pedantic = 1163, */                 /* -pedantic */
  OPT_pedantic_errors = 1164,                /* -pedantic-errors */
  OPT_pg = 1165,                             /* -pg */
  OPT_pie = 1166,                            /* -pie */
  OPT_pipe = 1167,                           /* -pipe */
  OPT_posix = 1168,                          /* -posix */
  OPT_print_file_name_ = 1169,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1170,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1171,          /* -print-multi-directory */
  OPT_print_multi_lib = 1172,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1173,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1174,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1175,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1176,               /* -print-prog-name= */
  OPT_print_search_dirs = 1177,              /* -print-search-dirs */
  OPT_print_sysroot = 1178,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1179,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1180,                        /* -profile */
  OPT_pthread = 1181,                        /* -pthread */
  OPT_quiet = 1182,                          /* -quiet */
  OPT_r = 1183,                              /* -r */
  OPT_rdynamic = 1184,                       /* -rdynamic */
  OPT_remap = 1185,                          /* -remap */
  OPT_s = 1186,                              /* -s */
  OPT_s_bc_abi = 1187,                       /* -s-bc-abi */
  OPT_save_temps = 1188,                     /* -save-temps */
  OPT_save_temps_ = 1189,                    /* -save-temps= */
  OPT_shared = 1190,                         /* -shared */
  OPT_shared_libgcc = 1191,                  /* -shared-libgcc */
  /* OPT_specs = 1192, */                    /* -specs */
  OPT_specs_ = 1193,                         /* -specs= */
  OPT_static = 1194,                         /* -static */
  OPT_static_libasan = 1195,                 /* -static-libasan */
  OPT_static_libgcc = 1196,                  /* -static-libgcc */
  OPT_static_libgcj = 1197,                  /* -static-libgcj */
  OPT_static_libgfortran = 1198,             /* -static-libgfortran */
  OPT_static_libgo = 1199,                   /* -static-libgo */
  OPT_static_libstdc__ = 1200,               /* -static-libstdc++ */
  OPT_static_libtsan = 1201,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1202, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1203, */                /* -std=c++0x */
  OPT_std_c__11 = 1204,                      /* -std=c++11 */
  OPT_std_c__1y = 1205,                      /* -std=c++1y */
  OPT_std_c__98 = 1206,                      /* -std=c++98 */
  OPT_std_c11 = 1207,                        /* -std=c11 */
  /* OPT_std_c1x = 1208, */                  /* -std=c1x */
  /* OPT_std_c89 = 1209, */                  /* -std=c89 */
  OPT_std_c90 = 1210,                        /* -std=c90 */
  OPT_std_c99 = 1211,                        /* -std=c99 */
  /* OPT_std_c9x = 1212, */                  /* -std=c9x */
  OPT_std_f2003 = 1213,                      /* -std=f2003 */
  OPT_std_f2008 = 1214,                      /* -std=f2008 */
  OPT_std_f2008ts = 1215,                    /* -std=f2008ts */
  OPT_std_f95 = 1216,                        /* -std=f95 */
  OPT_std_gnu = 1217,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1218, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1219, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1220,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1221,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1222,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1223,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1224, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1225, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1226,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1227,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1228, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1229, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1230,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1231, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1232, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1233, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1234,                     /* -std=legacy */
  OPT_symbolic = 1235,                       /* -symbolic */
  OPT_t = 1236,                              /* -t */
  OPT_time = 1237,                           /* -time */
  OPT_time_ = 1238,                          /* -time= */
  OPT_tno_android_cc = 1239,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1240,                 /* -tno-android-ld */
